...
getgenv().ToTargets = function(p)
    ...
    local Library = Update:Window("    XETY","2.0",Enum.KeyCode.RightControl);

Main = Library:Tab("General",6026568198)
M = Library:Tab("Weapons","7251993295")
Ss = Library:Tab("Stats","7040410130")
P = Library:Tab("Player","7251993295")
R = Library:Tab("Dungeon","7044284832")
T = Library:Tab("Teleport","6035190846")
S = Library:Tab("Shop","6031265976")
D = Library:Tab("Fruit","7044233235")
Misc = Library:Tab("Misc","6034509993")
Esp = Library:Tab("Esp","12950874071")
...
spawn(function()
   while wait() do
    ...
    Main:Button("Refresh Weapon",function()
     ...
     Main:Toggle("Auto Farm Level",,function(value)
